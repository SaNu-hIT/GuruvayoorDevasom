...
public class EventList {
    ...
    @SerializedName("AtendingValue")
    private String mAtendingValue;
    ...
    public String getAtendingValue() {
        return mAtendingValue;
    }

    public void setAtendingValue(String AtendingValue) {
        mAtendingValue = AtendingValue;
    }
